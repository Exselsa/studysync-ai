...
## Corpus Check
- 52 files · ~105,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 458 nodes · 516 edges · 31 communities detected
...
5. `normalizeStudyPlanData()` - 5 edges
6. `router` - 4 edges
7. `RESPONSE_SCHEMA` - 4 edges
8. `maxDuration` - 4 edges
9. `EMIL_EASE_ARR` - 4 edges
10. `containerVariants` - 4 edges

## Surprising Connections (you probably didn't know these)
- `POST()` --calls--> `formData`  [INFERRED]
  C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\app\api\study-plan\route.ts → C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\components\study\MaterialUploader.tsx
- `POST()` --calls--> `uploadPdfToGemini()`  [INFERRED]
  C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\app\api\study-plan\route.ts → C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\lib\gemini-pdf.ts
- `POST()` --calls--> `analyzePdfDocument()`  [INFERRED]
  C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\app\api\study-plan\route.ts → C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\lib\gemini-pdf.ts
- `POST()` --calls--> `parseFileBuffer()`  [INFERRED]
  C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\app\api\study-plan\route.ts → C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\lib\utils\file-parser.ts
- `POST()` --calls--> `generateStudyPlanFromPdfUri()`  [INFERRED]
  C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\app\api\study-plan\route.ts → C:\Users\Asus\.gemini\antigravity\scratch\studysync-ai\src\lib\gemini-pdf.ts
...
Cohesion: 0.04
Nodes (50): allPendingTasks, canProceedStep2, canProceedStep3, canProceedStep4, cardRef, circumference, containerVariants, coreFeatures (+42 more)

### Community 3 - "Community 3"

Cohesion: 0.08
Nodes (27): analyzePdfDocument(), DailyStudyPlanSchema, EquationSchema, GEMINI_PDF_SYSTEM_INSTRUCTION, generateStudyPlanFromPdfUri(), KeyConceptSchema, PDF_ANALYSIS_RESPONSE_SCHEMA, PdfAnalysisSchema (+19 more)

### Community 4 - "Community 4"

Cohesion: 0.07
Nodes (23): accent, [actionLoading, setActionLoading], avgPct, cardVariants, circ, [collapsed, setCollapsed], completedCount, dash (+15 more)
...
Cohesion: 0.09
Nodes (21): extractPrintableStrings(), extractTextFromDocx(), parseFileBuffer(), sanitizeText(), EASE, ext, extractedText, file (+13 more)
...
## Knowledge Gaps
- **256 isolated node(s):** `plusJakartaSans`, `spaceGrotesk`, `viewport`, `EASE_EMIL_OUT_ARR`, `fadeUp` (+251 more)
...
- **Thin community `Community 23`** (2 nodes): `orbs`, `BackgroundCanvas.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `SmoothScrollProvider.tsx`, `SmoothScrollProvider()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `useStudyTimer.ts`, `useStudyTimer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `cn.ts`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `loading.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `VoiceChat.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Providers.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
