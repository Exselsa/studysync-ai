...
## Corpus Check
- 49 files · ~104,312 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 449 nodes · 488 edges · 31 communities detected
...
Cohesion: 0.09
Nodes (10): async(), handleAttack, handleKeyDown(), commitDuelEvaluation(), findUserByEmail(), saveUserProfile(), sendDuelTaunt(), sendFriendRequest() (+2 more)
...
## Knowledge Gaps
- **253 isolated node(s):** `plusJakartaSans`, `spaceGrotesk`, `viewport`, `EASE_EMIL_OUT_ARR`, `fadeUp` (+248 more)
