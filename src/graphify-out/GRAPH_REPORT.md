...
Cohesion: 0.12
Nodes (18): extractPrintableStrings(), extractTextFromDocx(), extractTextFromPdf(), parseFileBuffer(), sanitizeText(), buildFallback(), buildFallbackResponse(), FALLBACK_QUESTIONS (+10 more)
